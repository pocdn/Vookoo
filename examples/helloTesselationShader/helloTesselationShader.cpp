...
int main() {
  ...
  // Create shaders.
  vku::ShaderModule vert{device, BINARY_DIR "helloTesselationShader.vert.spv"};
  vku::ShaderModule tesc{device, BINARY_DIR "helloTesselationShader.tesc.spv"};
  vku::ShaderModule tese{device, BINARY_DIR "helloTesselationShader.tese.spv"};
  vku::ShaderModule geom{device, BINARY_DIR "helloTesselationShader.geom.spv"};
  vku::ShaderModule frag{device, BINARY_DIR "helloTesselationShader.frag.spv"};
